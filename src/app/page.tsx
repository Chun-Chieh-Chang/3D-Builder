          ...
          {activeTab === 'FEATURES' ? (
            ...
            <div className="flex items-center gap-1.5 h-full">
              ...
              >
                ...
                title=" (Circle)"
              >
                <span className="text-lg group-hover:scale-110 transition-all"> </span> <span className="text-[13px] text-slate-800 font-bold leading-none">Circle</span> </button> <button
