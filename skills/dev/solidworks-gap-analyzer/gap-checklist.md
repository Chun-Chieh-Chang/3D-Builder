...
| **Reference Point** | Center of Face | ✅ Implemented | [geometry_service.py](file:///c:/Users/USER/Downloads/3D-Builder/backend/app/services/geometry_service.py) | Medium | Create reference points at geometric center of faces or midpoints of edges. Used as references for holes/planes. |
| **Dome Feature** | Rounding Surfaces | ✅ Implemented | [geometry_service.py](file:///c:/Users/USER/Downloads/3D-Builder/backend/app/services/geometry_service.py) | Medium | Round off faces using spherical cap approximation. Supports distance and reverse direction. |
